...
def update_graph(xaxis_column,yaxis_column,graph_type):
    if graph_type == 'bar':
        fig = go.bar(df,x=xaxis_column,y=yaxis_column)
    elif graph_type == 'box':
        fig = go.box(df,x=xaxis_column,y=yaxis_column)
    elif graph_type == 'violin':
        fig = go.violin(df,x=xaxis_column,y=yaxis_column)
    elif graph_type == 'scatter':
        fig = go.scatter(df,x=xaxis_column,y=yaxis_column)
    elif graph_type == 'scatter3d':
        fig = go.scatter_3d(df,x=xaxis_column,y=yaxis_column,z='sepal_width')
